...
В первую очередь я старался создать функционал, соответствующий требованиям из предоставленной спецификации. И в то же время старался писать чистый, легкий и понятный код, избегая сложных, громоздких решений. К которым, возможно придется прийти в дальнейшем, в зависимосчти от будущих требований к приложению.
Конечно же тут есть над чем еще поработать, например, для покрытия чуть более нестандартных юз-кейсов. 
